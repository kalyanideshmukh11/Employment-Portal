        ...
        <div class='jumbotron' style={{paddingBottom: "0px"}}>
                <div class='row'>
                    ...
                    <div class='col-xs-4 profileName' style={{marginLeft: "200px"}}>
                        ...
                        <br />
                        <Button href = '/company' style={{backgroundColor: "transparent", color: "green", border: "none", fontSize: "23px" }}> Overview </Button>
                        <Button style={{backgroundColor: "transparent", color: "green", border: "none", borderLeft: "1px solid #A9A9A9", fontSize: "23px"}}> Jobs </Button>
